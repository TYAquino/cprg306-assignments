...
export default function Item({ name, quantity, category }) {
  return (
    <li class="border rounded border-sky-500 mx-auto w-full max-w-xs m-4 p-2 list-none hover:scale-110 transition duration-300 ease-in-out hover:bg-gray-800">
      <div>
